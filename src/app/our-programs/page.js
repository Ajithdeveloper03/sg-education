        ...
        <div className="op-container">
          ...
          <div className="op-cards-row">
             <div className="op-card-left">
                ...
                <img src="/sg-education/girl_writing.png" alt="Girl writing" className="op-card-img-left" />
             ...
             <div className="op-card-right">
                ...
                <img src="/sg-education/boy_thumbs_up.png" alt="Boy thumbs up" className="op-card-img-right" />
             </div>
          </div>
